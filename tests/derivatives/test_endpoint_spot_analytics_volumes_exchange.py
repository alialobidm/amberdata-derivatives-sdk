...
class EndpointSpotAnalyticsVolumesExchangeTestCase(BaseTestCase):
    # pylint: disable-next=arguments-differ
    def setUp(self):
        super().setUp(
            function_name='get_spot_analytics_volumes_exchange'
        )

    # ==================================================================================================================

    def test_default(self):
        response = self.call_endpoint(exchange='gdax', startDate='2025-06-01', endDate='2025-06-02', orderSizeCategoryUsd='All')
    ...
    def test_invalid_parameter(self):
        response = self.call_endpoint(exchange='gdax', startDate='2025-06-01', endDate='2025-06-02', orderSizeCategoryUsd='All', invalid='parameter')
        self.validate_response_data(response)
        self.validate_response_400(response, ErrorMessage.UNSUPPORTED_PARAMETER_INVALID)

    def test_unknown_exchange(self):
        response = self.call_endpoint(exchange='<exchange>', startDate='2025-06-01', endDate='2025-06-02', orderSizeCategoryUsd='All')
        self.validate_response_data(response)
